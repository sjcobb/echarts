...
class IntervalScale<SETTING extends ScaleSettingDefault = ScaleSettingDefault> extends Scale<SETTING> {
     ...
     */
    calcNiceTicks(splitNumber?: number, minInterval?: number, maxInterval?: number, intervalBase?: number): void {
        ...
        const result = helper.intervalScaleNiceTicks(
            extent, span, splitNumber, minInterval, maxInterval, intervalBase
        );
    ...
    calcNiceExtent(opt: {
        ...
        this.calcNiceTicks(opt.splitNumber, opt.minInterval, opt.maxInterval, opt.intervalBase);
        const interval = this._interval;
